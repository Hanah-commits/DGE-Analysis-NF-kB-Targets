...
sample_data <- data.frame(
  sample = c("BL1b","BL2b", "BL3b","BL4a","BL5a","BL6a"),
  condition = c("Illumination_negative_control", "Illumination_negative_control", "Illumination_negative_control", "Illumination_positive_control", "Illumination_positive_control", "Illumination_positive_control"),
...
ggplot(sleuth_table_WT, aes(x = b/log(2), y = -log10(qval))) +
  ...
  theme_minimal()+
  ggtitle("Blue Light: empty vector vs eGFP-RelA")+
