...
sample_data <- data.frame(
  sample = c("BL4b","BL5b", "BL6b","D4a","D5a","D6a"),
  condition = c("Illumination_positive_control", "Illumination_positive_control", "Illumination_positive_control", "Darkness_positive_control", "Darkness_positive_control", "Darkness_positive_control"),
  replicate = c(1, 2, 3, 1, 2, 3),
  path = c(
    "Quantification/output/BL4b/abundance.h5", 
    "Quantification/output/Bl5b/abundance.h5", 
    "Quantification/output/BL6b/abundance.h5",
    "Quantification/output/D4a/abundance.h5",
    "Quantification/output/D5a/abundance.h5", 
    "Quantification/output/D6a/abundance.h5"),
...
saveRDS(sleuth_obj, file = "pos.rds")
...
# METHOD2: WT test
sleuth_obj = sleuth_wt(sleuth_obj, 'conditionIllumination_positive_control')

sleuth_table_WT = sleuth_results(sleuth_obj, 'conditionIllumination_positive_control', test_type = 'wt')
...
ggplot(sleuth_table_WT, aes(x = b/log(2), y = -log10(qval))) +
  ...
  theme_minimal()+
  ggtitle("eGFP-RelA: Darkness vs Blue Light")+
